...
Репозиторий создан для реализации сценария остановки виртуальных машин и отправки уведомлений в Telegram вследствие вызова триггера для бюджетов и триггера для Message Queue.
